    ...
    $(document).on(
            ...
            var t = "",
                ...
                "" != i &&
                    $(".todo-task-list-wrapper").append(
                        '<li class="todo-item" style="animation-delay: 0s;"  data-toggle="modal" data-target="#editTaskModal"><div class="todo-title-wrapper d-flex justify-content-between mb-50"><div class="todo-title-area d-flex align-items-center"><div class="title-wrapper d-flex"><div class="vs-checkbox-con"><input type="checkbox" class="permissionId" value="' + res.permissionId + '"><span class="vs-checkbox vs-checkbox-sm"><span class="vs-checkbox--check"><i class="vs-icon feather icon-check"></i></span></span></div><h6 class="todo-title mt-50 mx-50">' +
                            i +
                            ...
                            e +
                            '"><i class="feather icon-star"></i></a><a class="todo-item-delete" data-value="' + res.permissionId +  '"><i class="feather icon-trash"></i></a></div></div></li>'
        ...
        $(document).on(
            ...
            function (o) {
                ...
                $("#form-edit-todo .vs-checkbox-con input").prop("checked", !1),
                    ...
                    $("#form-edit-todo .permissionId").val(id),
        ...
        $(".update-todo-item").on("click", function () {
            ...
            var o = $("#form-edit-todo .edit-todo-item-title").val(),
                ...
                id = $("#form-edit-todo .permissionId").val(),
                roleIds = [];
            ...
            i.each(function () {
                ...
                $.ajax({
                    ...
                    data: {name:o,roleIds},
                    success:function(res) {
                    toastr.info("Permission has been updated");
        ...
        $(document).on("click", ".todo-item-delete", function (o) {
            ...
            $.ajax({
                ...
                url: `/permission/${id}`,
                success:function(res) {
                    toastr.warning("Permission has been deleted!");
        ...
        $("#role-update-search").on("keyup", function () {
            var o = $(this).val().toLowerCase();
            console.log(o);
            "" != o
                ? ($(".title-wrapper").filter(function () {
