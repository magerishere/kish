        ...
        $(".add-todo-item").on("click", function (o) {
            ...
            var t = "",
                ...
                $(".modal.show .todo-item-favorite").hasClass("warning") &&
                    (e = " warning"),
                $("select[name='custom-select[]'] option:selected").each(function () {
                ...
                "" != i &&
                    $(".todo-task-list-wrapper").append(
                        '<li class="todo-item" style="animation-delay: 0s;"  data-toggle="modal" data-target="#editTaskModal"><div class="todo-title-wrapper d-flex justify-content-between mb-50"><div class="todo-title-area d-flex align-items-center"><div class="title-wrapper d-flex"><div class="vs-checkbox-con"><input type="checkbox" class="roleId" value="' + res.roleId + '"><span class="vs-checkbox vs-checkbox-sm"><span class="vs-checkbox--check"><i class="vs-icon feather icon-check"></i></span></span></div><h6 class="todo-title mt-50 mx-50">' +
                            i +
                            ...
                            e +
                            '"><i class="feather icon-star"></i></a><a class="todo-item-delete" data-value="' + res.roleId +  '"><i class="feather icon-trash"></i></a></div></div></li>'
        ...
        $(".update-todo-item").on("click", function () {
            ...
            var o = $("#form-edit-todo .edit-todo-item-title").val(),
                ...
                $(s).parent(".todo-item-favorite").hasClass("warning") &&
                    c.addClass("warning");
            var i = $("select[name='custom-select[]'] option:selected"),
                a = "";
